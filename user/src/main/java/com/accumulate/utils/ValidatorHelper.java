...
public class ValidatorHelper {
	...
	public static void error(String key, String message) {
		ApplicationException e = new ApplicationException(CommonErrorCode.VALIDATION_ERROR, message);
	...
	public static void validate(Object obj) {
		...
		if (constraints.size() > 0) {
			ApplicationException e = new ApplicationException(CommonErrorCode.VALIDATION_ERROR);
